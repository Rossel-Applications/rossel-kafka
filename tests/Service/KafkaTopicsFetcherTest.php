...
final class KafkaTopicsFetcherTest extends TestCase
{
    ...
    public function constructorIgnoresNullTopics(): void
    {
        $fetcher = new KafkaTopicsFetcher([
            TopicConfigKeys::PUBLIC_LOG_OUTPUT_V1_JSON_DELETE->value => null,
        ]);
    ...
    {
        $fetcher = new KafkaTopicsFetcher([
            TopicConfigKeys::PUBLIC_LOG_OUTPUT_V1_JSON_DELETE->value => '',
        ]);
    ...
    {
        $fetcher = new KafkaTopicsFetcher([
            TopicConfigKeys::PUBLIC_LOG_OUTPUT_V1_JSON_DELETE->value => 'public.log.output',
        ]);
    ...
    public function constructorSkipsNullAndKeepsValid(): void
    {
        $fetcher = new KafkaTopicsFetcher([
            TopicConfigKeys::PUBLIC_LOG_OUTPUT_V1_JSON_DELETE->value => 'public.log.output',
            TopicConfigKeys::PUBLIC_DEAD_LETTER_INOUT_V1_JSON_DELETE_D30->value => null,
            TopicConfigKeys::PUBLIC_SUBSCRIPTION_INPUT_V1_JSON_DELETE->value => 'subscriptions.input',
        ]);
    ...
    public function getReturnsTopicForConfiguredKey(): void
    {
        ...
        $topic = $fetcher->get(TopicConfigKeys::PUBLIC_LOG_OUTPUT_V1_JSON_DELETE);
    ...
    public function getThrowsUnconfiguredTopicExceptionForMissingKey(): void
    {
        ...
        $fetcher->get(TopicConfigKeys::PUBLIC_LOG_OUTPUT_V1_JSON_DELETE);
    }
    ...
    {
        $fetcher = new KafkaTopicsFetcher([
            TopicConfigKeys::PUBLIC_LOG_OUTPUT_V1_JSON_DELETE->value => 'log.topic',
            TopicConfigKeys::PUBLIC_SUBSCRIPTION_INPUT_V1_JSON_DELETE->value => 'sub.input.topic',
        ]);

        $all = $fetcher->getAll();

        self::assertArrayHasKey(TopicConfigKeys::PUBLIC_LOG_OUTPUT_V1_JSON_DELETE->name, $all);
        self::assertArrayHasKey(TopicConfigKeys::PUBLIC_SUBSCRIPTION_INPUT_V1_JSON_DELETE->name, $all);
        self::assertSame('log.topic', $all[TopicConfigKeys::PUBLIC_LOG_OUTPUT_V1_JSON_DELETE->name]->getName());
    }
    ...
    public function getByMessageTypeReturnsMultipleMatchingTopics(): void
    {
        $fetcher = new KafkaTopicsFetcher([
            TopicConfigKeys::PUBLIC_LOG_OUTPUT_V1_JSON_DELETE->value => 'log.topic',
            TopicConfigKeys::ACCOUNT_API_PUBLIC_LOG_OUTPUT_V1_JSON_DELETE->value => 'account.log.topic',
        ]);

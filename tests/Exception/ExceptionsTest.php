...
final class ExceptionsTest extends TestCase
{
    ...
    {
        yield 'log output' => [TopicConfigKeys::PUBLIC_LOG_OUTPUT_V1_JSON_DELETE];
        yield 'subscription input' => [TopicConfigKeys::PUBLIC_SUBSCRIPTION_INPUT_V1_JSON_DELETE];
    }
    ...
    {
        $exception = new UnconfiguredTopicException(TopicConfigKeys::PUBLIC_LOG_OUTPUT_V1_JSON_DELETE);
    ...
    {
        $key = TopicConfigKeys::PUBLIC_LOG_OUTPUT_V1_JSON_DELETE;
        $exception = new UnconfiguredTopicException($key);

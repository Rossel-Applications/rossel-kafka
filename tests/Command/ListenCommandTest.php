...
final class ListenCommandTest extends TestCase
{
    ...
    public function executeCallsOrchestratorListenForSingleTopic(): void
    {
        $this->fetcher
            ->method('get')
            ->with(TopicConfigKeys::PUBLIC_LOG_OUTPUT_V1_JSON_DELETE)
        ...
        $tester = new CommandTester($this->command);
        $exitCode = $tester->execute([
            '--topics' => TopicConfigKeys::PUBLIC_LOG_OUTPUT_V1_JSON_DELETE->value,
        ]);
    ...
    public function commaSeparatedTopicsAreParsedIndividually(): void
    {
        $this->fetcher
            ->method('get')
            ->willReturnMap([
                [TopicConfigKeys::PUBLIC_LOG_OUTPUT_V1_JSON_DELETE, $this->logTopic],
                [TopicConfigKeys::PUBLIC_SUBSCRIPTION_INPUT_V1_JSON_DELETE, $this->subTopic],
            ]);
        ...
        $exitCode = $tester->execute([
            '--topics' => TopicConfigKeys::PUBLIC_LOG_OUTPUT_V1_JSON_DELETE->value
                .','.TopicConfigKeys::PUBLIC_SUBSCRIPTION_INPUT_V1_JSON_DELETE->value,
        ]);

...
enum MessageType
{
    case B2B_CREATE_OR_UPDATE_CONTACT;
    case B2B_CREATE_OR_UPDATE_CONTRACT;
    case B2B_CREATE_OR_UPDATE_CUSTOMER;
    case B2B_CREATE_OR_UPDATE_INVOICE;
    case B2B_CREATE_OR_UPDATE_OPPORTUNITY;
    case B2B_CREATE_OR_UPDATE_ORDER;
    case B2B_CREATE_OR_UPDATE_REFERENCE_ITEM;
    case B2B_CREATE_OR_UPDATE_SALES_REP;
    case B2B_DELETE_CONTACT;
    case B2B_DELETE_CUSTOMER;
